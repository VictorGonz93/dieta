...
if ('serviceWorker' in navigator) {
    ...
    // 🔄 ESCUCHAR UPDATES DEL SERVICE WORKER (Pasivo)
...
// ==================== UPDATE CHECKER (Híbrido - Polling Activo) ====================
...
async function checkForUpdates() {
    try {
        // Fetch del sw.js con cache-busting para obtener versión fresca
        const response = await fetch('sw.js?_t=' + Date.now(), {
            cache: 'no-store' // Ignorar cache del navegador
        });
        ...
        // Extraer CACHE_VERSION del contenido
        // Busca: const CACHE_VERSION = XX;
        ...
        // Silencioso: si falla el check, no interrumpir la app
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🔄 Iniciar update checker (híbrido: SW + polling activo)
    startUpdateChecker();
});

// ==================== UPDATE MODAL FUNCTIONS ====================
function showUpdateAvailableModal(remoteVersion = null) {
    // Verificar si ya existe modal de update
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                ...
                <button id="updateModalConfirm" style="
                    flex: 1;
                    padding: 10px 16px;
                    border: none;
                    border-radius: 8px;
...
function performUpdate() {
    ...
    // Esperar 1 segundo para que se limpie todo, luego recargar
    setTimeout(() => {
