const CACHE_VERSION = 110; // Incrementa esto cuando hagas cambios
...
const urlsToCache = [
    ...
    '/dieta/manifest.json',
    '/dieta/icons/icon-192.png',
    '/dieta/icons/icon-512.png',
    '/dieta/icons/apple-touch-icon.png',
    '/dieta/icons/favicon-32x32.png',
    '/dieta/favicon.ico',
    // CDN Resources
